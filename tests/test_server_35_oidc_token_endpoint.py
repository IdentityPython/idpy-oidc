...
class TestEndpoint(_TestEndpoint):
    ...
    def test_do_2nd_refresh_access_token(self):
        ...
        _2nd_req = self.token_endpoint.parse_request(_request.to_urlencoded())
    ...
    def test_new_refresh_token(self, conf):
        ...
        _2nd_req = self.token_endpoint.parse_request(_refresh_request.to_urlencoded())
        ...
        _3rd_req = self.token_endpoint.parse_request(_2d_refresh_request.to_urlencoded())
...
class TestOldTokens(object):
    ...
    def test_old_default_token_sid_unencrypted(self):
        ...
        _clear_txt_sid = self.session_manager.branch_key(
            *self.session_manager.decrypt_branch_id(_res["sid"])
        )
        ...
        _session_info = self.session_manager.get_branch_info_by_token(_old_type_token)
