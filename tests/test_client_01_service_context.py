...
class TestServiceContext:
    ...
    def test_get_sign_alg(self):
        ...
        self.service_context.metadata.set_preference("id_token_signed_response_alg", "RS384")
        _alg = self.service_context.get_sign_alg("id_token")
        assert _alg == "RS384"

        self.service_context.metadata.prefer = {}
    ...
    def test_get_enc_alg_enc(self):
        ...
        self.service_context.metadata.set_preference("userinfo_encrypted_response_alg", "RSA1_5")
        self.service_context.metadata.set_preference("userinfo_encrypted_response_enc",
                                                     "A128CBC+HS256")
