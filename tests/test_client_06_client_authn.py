...
class TestClientSecretBasic(object):
    def test_construct(self, entity):
        ...
        request = _service.construct(redirect_uri="http://example.com",
                                     state='ABCDE')
...
class TestBearerHeader(object):
    ...
    def test_construct_with_token(self, entity):
        ...
        response = _service.parse_response(
        ...
        _service.client_get("service_context").state.store_item(response, 'token_response',
                                                                key=_state)
...
class TestBearerBody(object):
    ...
    def test_construct_with_request(self, entity):
        ...
        _service2.client_get("service_context").state.store_item(response, 'token_response',
                                                                 key=_key)
