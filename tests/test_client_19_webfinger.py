...
ENTITY = Entity(config={'conf': {"base_url": "https://example.com"}})
...
def test_query():
    ...
    example_oidc = {
        ...
        "example.com/joe": ("example.com", rel, "https%3A%2F%2Fexample.com%2Fjoe"),
        "example.com:8080": ("example.com:8080", rel, "https%3A%2F%2Fexample.com%3A8080"),
        "Jane.Doe@example.com": ("example.com", rel, "acct%3AJane.Doe%40example.com"),
        "alice@example.com:8080": (
            "alice@example.com:8080",
            rel,
            "https%3A%2F%2Falice%40example.com%3A8080",
        ),
        "https://example.com": ("example.com", rel, "https%3A%2F%2Fexample.com"),
        "https://example.com/joe": ("example.com", rel, "https%3A%2F%2Fexample.com%2Fjoe"),
        "https://joe@example.com:8080": (
            "joe@example.com:8080",
            rel,
            "https%3A%2F%2Fjoe%40example.com%3A8080",
        ),
        "acct:joe@example.com": ("example.com", rel, "acct%3Ajoe%40example.com"),
    }

    wf = WebFinger(ENTITY.upstream_get)
...
def test_query_2():
    ...
    example_oidc = {
        ...
        "example.com?query": ("example.com", rel, "https%3A%2F%2Fexample.com%3Fquery"),
        "example.com#fragment": ("example.com", rel, "https%3A%2F%2Fexample.com"),
        "example.com:8080/path?query#fragment": (
            "example.com:8080",
            rel,
            "https%3A%2F%2Fexample.com%3A8080%2Fpath%3Fquery",
        ),
        "http://example.com/path": ("example.com", rel, "http%3A%2F%2Fexample.com%2Fpath"),
        "http://example.com?query": ("example.com", rel, "http%3A%2F%2Fexample.com%3Fquery"),
        "http://example.com#fragment": ("example.com", rel, "http%3A%2F%2Fexample.com"),
        ...
        "nov@example.com/path": ("nov@example.com", rel, "https%3A%2F%2Fnov%40example.com%2Fpath"),
        "nov@example.com?query": (
            "nov@example.com",
            rel,
            "https%3A%2F%2Fnov%40example.com%3Fquery",
        ),
        "nov@example.com#fragment": ("nov@example.com", rel, "https%3A%2F%2Fnov%40example.com"),
        "nov@example.com:8080/path?query#fragment": (
            "nov@example.com:8080",
            rel,
            "https%3A%2F%2Fnov%40example.com%3A8080%2Fpath%3Fquery",
        ),
        "acct:nov@example.com:8080": ("example.com:8080", rel, "acct%3Anov%40example.com%3A8080"),
        "acct:nov@example.com/path": ("example.com", rel, "acct%3Anov%40example.com%2Fpath"),
        "acct:nov@example.com?query": ("example.com", rel, "acct%3Anov%40example.com%3Fquery"),
        "acct:nov@example.com#fragment": ("example.com", rel, "acct%3Anov%40example.com"),
...
def test_link3():
    link = Link(rel="http://webfinger.net/rel/profile-page", href="http://www.example.com/~bob/")
...
def test_jrd():
    jrd = JRD(
        ...
        links=[
            ...
            Link(rel="http://webfinger.net/rel/profile-page", href="http://www.example.com/~bob/"),
        ],
    )
...
class TestWebFinger(object):
    def test_query_device(self):
        ...
        _info = wf.get_request_parameters(context, request_args)
    ...
    def test_query_acct(self):
        context = ENTITY.context['']
        wf = WebFinger(ENTITY.upstream_get, rel=OIC_ISSUER)
        request_args = {"resource": "acct:carol@example.com"}
        _info = wf.get_request_parameters(context, request_args=request_args)
    ...
    def test_query_acct_resource_kwargs(self):
        ...
        _info = wf.get_request_parameters(
            context,
            request_args=request_args, resource="acct:carol@example.com"
        )
    ...
    def test_query_acct_no_resource(self):
        ...
        with pytest.raises(MissingRequiredAttribute):
            wf.get_request_parameters(context, request_args=request_args)
