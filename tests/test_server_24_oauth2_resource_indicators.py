...
class TestEndpoint(object):
    ...
    def create_endpoint_ri_disabled(self):
        ...
        context.keyjar.import_jwks(
            context.keyjar.export_jwks(True, ""), conf["issuer"]
        )
    ...
    def test_authorization_code_req_per_client(self, create_endpoint_ri_disabled):
        ...
        """
        context = self.endpoint.upstream_get("context")
        context.cdb["client_1"]["resource_indicators"] = {
            "authorization_code": {
                "policy": {
                    "callable": validate_authorization_resource_indicators_policy,
                    "kwargs": {
    ...
    def test_authorization_code_req_no_resource_client(self, create_endpoint_ri_enabled):
        ...
        msg = self.endpoint._post_parse_request(request, client_id, context)
