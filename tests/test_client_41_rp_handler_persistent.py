...
CLIENT_CONFIG = {
    "": {
        ...
        "services": {
            'web_finger': {
                'class': 'idpyoidc.client.oidc.webfinger.WebFinger'
            },
            "discovery": {
                'class': 'idpyoidc.client.oidc.provider_info_discovery'
            ...
            'refresh_access_token': {
                'class': 'idpyoidc.client.oidc.refresh_access_token'
                         '.RefreshAccessToken'
            },
            'userinfo': {
    ...
    "linkedin": {
        ...
        'services': {
            ...
            'access_token': {
                'class': 'idpyoidc.client.provider.linkedin.AccessToken'
            },
            'userinfo': {
                'class': 'idpyoidc.client.provider.linkedin.UserInfo'
            }
        }
    },
    "facebook": {
...
class TestRPHandler(object):
    ...
    def test_finalize_auth(self):
        ...
        aresp = client.client_get("service", 'authorization').client_get(
            "service_context").state.get_item(
    ...
    def test_get_tokens(self):
        ...
        with responses.RequestsMock() as rsps:
            ...
            atresp = client.client_get("service", 'accesstoken').client_get(
                "service_context").state.get_item(
