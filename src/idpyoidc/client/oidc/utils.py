...
def request_object_encryption(msg, service_context, **kwargs):
    ...
    try:
        ...
        try:
            encalg = service_context.work_condition.behaviour["request_object_encryption_alg"]
        except KeyError:
            return msg
    ...
    try:
        ...
        try:
            encenc = service_context.work_condition.behaviour["request_object_encryption_enc"]
        except KeyError:
