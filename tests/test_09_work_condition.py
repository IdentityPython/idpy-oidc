...
class TestWorkEnvironment:
    ...
    def test_load_conf(self):
        ...
        self.metadata.load_conf(client_conf, self.supported)
        assert self.metadata.get_preference('jwks') is None
        assert self.metadata.get_preference('jwks_uri') is None
    ...
    def test_load_jwks(self):
        ...
        self.metadata.load_conf(client_conf, self.supported)
        assert self.metadata.get_preference('jwks') is not None
        assert self.metadata.get_preference('jwks_uri') is None
    ...
    def test_load_jwks_uri1(self):
        ...
        self.metadata.load_conf(client_conf, self.supported)
        assert self.metadata.get_preference('jwks') is None
        assert self.metadata.get_preference(
    ...
    def test_load_jwks_uri2(self):
        ...
        self.metadata.load_conf(client_conf, self.supported)
        assert self.metadata.get_preference('jwks') is None
        assert self.metadata.get_preference('jwks_uri') == client_conf['jwks_uri']
    ...
    def test_registration_response(self):
        ...
        pref = self.metadata.supported_to_preferred(supported=self.supported,
