...
class Metadata(client_metadata.Metadata):
    parameter = client_metadata.Metadata.parameter.copy()
    parameter.update({
        "requests_dir": None
    })
    ...
    def __init__(self,
        ...
        client_metadata.Metadata.__init__(self, prefer=prefer, callback_path=callback_path)
