...
class TestDPoPWithoutUserinfo:
    ...
    def test_add_header(self):
        token_serv = self.client.get_service(self.context, "accesstoken")
        req_args = {
            "grant_type": "authorization_code",
            "code": "SplxlOBeZQQYbYS6WxSbIA",
            "redirect_uri": "https://client/example.com/cb",
        }
        headers = token_serv.get_headers(self.context, request=req_args, http_method="POST")
        assert headers
...
class TestDPoPWithUserinfo:
    ...
    def test_add_header_userinfo(self):
        userinfo_serv = self.client.get_service(self.context, "userinfo")
        req_args = {}
